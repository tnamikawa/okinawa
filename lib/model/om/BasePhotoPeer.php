...
/**
 * Base static class for performing query and update operations on the 'photo_mst' table.
 *
 * 
 *
...
abstract class BasePhotoPeer {
	...
	/** the column name for the ICON_WIDTH field */
	const ICON_WIDTH = 'photo_mst.ICON_WIDTH';

	/** the column name for the ICON_HEIGHT field */
	const ICON_HEIGHT = 'photo_mst.ICON_HEIGHT';

	/** the column name for the WANDER_WIDTH field */
	const WANDER_WIDTH = 'photo_mst.WANDER_WIDTH';

	/** the column name for the WANDER_HEIGHT field */
	const WANDER_HEIGHT = 'photo_mst.WANDER_HEIGHT';

	/** the column name for the SLIDE_WIDTH field */
	const SLIDE_WIDTH = 'photo_mst.SLIDE_WIDTH';

	/** the column name for the SLIDE_HEIGHT field */
	...
	/** the column name for the METAMODIFIED_DATE field */
	const METAMODIFIED_DATE = 'photo_mst.METAMODIFIED_DATE';

	/** the column name for the FILEMTIME field */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'filename', 'comment', 'width', 'height', 'thumbWidth', 'thumbHeight', 'iconWidth', 'iconHeight', 'wanderWidth', 'wanderHeight', 'slideWidth', 'slideHeight', 'longitude', 'latitude', 'shotDate', 'openDate', 'modifiedDate', 'metamodifiedDate', 'filemtime', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::FILENAME, self::COMMENT, self::WIDTH, self::HEIGHT, self::THUMB_WIDTH, self::THUMB_HEIGHT, self::ICON_WIDTH, self::ICON_HEIGHT, self::WANDER_WIDTH, self::WANDER_HEIGHT, self::SLIDE_WIDTH, self::SLIDE_HEIGHT, self::LONGITUDE, self::LATITUDE, self::SHOT_DATE, self::OPEN_DATE, self::MODIFIED_DATE, self::METAMODIFIED_DATE, self::FILEMTIME, self::CREATED_AT, self::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::FILENAME => 2, self::COMMENT => 3, self::WIDTH => 4, self::HEIGHT => 5, self::THUMB_WIDTH => 6, self::THUMB_HEIGHT => 7, self::ICON_WIDTH => 8, self::ICON_HEIGHT => 9, self::WANDER_WIDTH => 10, self::WANDER_HEIGHT => 11, self::SLIDE_WIDTH => 12, self::SLIDE_HEIGHT => 13, self::LONGITUDE => 14, self::LATITUDE => 15, self::SHOT_DATE => 16, self::OPEN_DATE => 17, self::MODIFIED_DATE => 18, self::METAMODIFIED_DATE => 19, self::FILEMTIME => 20, self::CREATED_AT => 21, self::UPDATED_AT => 22, ),
	...
	/**
	 * Method to invalidate the instance pool of all tables related to photo_mst
	...
	{
		return $withPrefix ? PhotoPeer::CLASS_DEFAULT : PhotoPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePhotoPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePhotoPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePhotoPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePhotoPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePhotoPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePhotoPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePhotoPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePhotoPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the photo_mst table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
