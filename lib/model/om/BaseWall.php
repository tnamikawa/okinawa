...
/**
 * Base class that represents a row from the 'wall_mst' table.
 *
 * 
 *
...
abstract class BaseWall extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = WallPeer::NUM_COLUMNS - WallPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseWall:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseWall:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseWall:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseWall:save:post') as $callable)
				{
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseWall:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseWall::%s', $method));
	  }
