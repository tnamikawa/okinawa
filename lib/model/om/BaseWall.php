...
abstract class BaseWall extends BaseObject  implements Persistent {
	...
	public function setPhotoId($v)
	{
		...
		if ($this->photo_id !== $v) {
			$this->photo_id = $v;
			$this->modifiedColumns[] = WallPeer::PHOTO_ID;
		}
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = WallPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += WallPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(WallPeer::PHOTO_ID)) $criteria->add(WallPeer::PHOTO_ID, $this->photo_id);
