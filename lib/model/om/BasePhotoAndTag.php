...
/**
 * Base class that represents a row from the 'photo_and_tag_rel' table.
 *
 * 
 *
...
abstract class BasePhotoAndTag extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the open_flag field.
	 * @var        int
	 */
	protected $open_flag;
	...
	/**
	 * Get the [open_flag] column value.
	 * 
	 * @return     int
	 */
	 ...
	 * @return     PhotoAndTag The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [open_flag] column.
	 * 
	 * @param      int $v new value
	 * @return     PhotoAndTag The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->open_flag = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = PhotoAndTagPeer::NUM_COLUMNS - PhotoAndTagPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PhotoAndTagPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BasePhotoAndTag:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePhotoAndTag:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BasePhotoAndTag:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePhotoAndTag:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				PhotoAndTagPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PhotoAndTag (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PhotoAndTag Clone of current object.
	 * @throws     PropelException
	 */
	...
	{
	  if (!$callable = sfMixer::getCallable('BasePhotoAndTag:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BasePhotoAndTag::%s', $method));
	  }
