...
abstract class BaseNotePeer {
	...
	const ID = 'note_mst.ID';

	
	const PHOTO_ID = 'note_mst.PHOTO_ID';

	
	const NAME = 'note_mst.NAME';

	
	const CONTENT = 'note_mst.CONTENT';

	
	const FONT_FAMILY = 'note_mst.FONT_FAMILY';

	
	const FONT_SIZE = 'note_mst.FONT_SIZE';

	
	const WRITE_DATE = 'note_mst.WRITE_DATE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'PhotoId', 'Name', 'Content', 'FontFamily', 'FontSize', 'WriteDate', ),
		BasePeer::TYPE_COLNAME => array (NotePeer::ID, NotePeer::PHOTO_ID, NotePeer::NAME, NotePeer::CONTENT, NotePeer::FONT_FAMILY, NotePeer::FONT_SIZE, NotePeer::WRITE_DATE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'photo_id', 'name', 'content', 'font_family', 'font_size', 'write_date', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PhotoId' => 1, 'Name' => 2, 'Content' => 3, 'FontFamily' => 4, 'FontSize' => 5, 'WriteDate' => 6, ),
		BasePeer::TYPE_COLNAME => array (NotePeer::ID => 0, NotePeer::PHOTO_ID => 1, NotePeer::NAME => 2, NotePeer::CONTENT => 3, NotePeer::FONT_FAMILY => 4, NotePeer::FONT_SIZE => 5, NotePeer::WRITE_DATE => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'photo_id' => 1, 'name' => 2, 'content' => 3, 'font_family' => 4, 'font_size' => 5, 'write_date' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NotePeer::PHOTO_ID);

		$criteria->addSelectColumn(NotePeer::NAME);

		$criteria->addSelectColumn(NotePeer::CONTENT);

		$criteria->addSelectColumn(NotePeer::FONT_FAMILY);

		$criteria->addSelectColumn(NotePeer::FONT_SIZE);

		$criteria->addSelectColumn(NotePeer::WRITE_DATE);

	}

	const COUNT = 'COUNT(note_mst.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT note_mst.ID)';
