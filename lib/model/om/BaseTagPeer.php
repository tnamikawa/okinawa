...
/**
 * Base static class for performing query and update operations on the 'tag_mst' table.
 *
 * 
 *
...
abstract class BaseTagPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'englishtitle', 'filename', 'description', 'orderPriority', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::ENGLISHTITLE, self::FILENAME, self::DESCRIPTION, self::ORDER_PRIORITY, self::CREATED_AT, self::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'englishtitle' => 2, 'filename' => 3, 'description' => 4, 'orderPriority' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::ENGLISHTITLE => 2, self::FILENAME => 3, self::DESCRIPTION => 4, self::ORDER_PRIORITY => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
	...
	/**
	 * Method to invalidate the instance pool of all tables related to tag_mst
	...
	/**
	 * Method to DELETE all rows from the tag_mst table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
