...
abstract class BaseTagPeer {
	...
	const TITLE = 'tag_mst.TITLE';

	
	const ENGLISHTITLE = 'tag_mst.ENGLISHTITLE';

	
	const FILENAME = 'tag_mst.FILENAME';

	
	const DESCRIPTION = 'tag_mst.DESCRIPTION';

	
	const ORDER_PRIORITY = 'tag_mst.ORDER_PRIORITY';

	
	const CREATED_AT = 'tag_mst.CREATED_AT';

	
	const UPDATED_AT = 'tag_mst.UPDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Englishtitle', 'Filename', 'Description', 'OrderPriority', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_COLNAME => array (TagPeer::ID, TagPeer::TITLE, TagPeer::ENGLISHTITLE, TagPeer::FILENAME, TagPeer::DESCRIPTION, TagPeer::ORDER_PRIORITY, TagPeer::CREATED_AT, TagPeer::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'englishtitle', 'filename', 'description', 'order_priority', 'created_at', 'updated_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Englishtitle' => 2, 'Filename' => 3, 'Description' => 4, 'OrderPriority' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (TagPeer::ID => 0, TagPeer::TITLE => 1, TagPeer::ENGLISHTITLE => 2, TagPeer::FILENAME => 3, TagPeer::DESCRIPTION => 4, TagPeer::ORDER_PRIORITY => 5, TagPeer::CREATED_AT => 6, TagPeer::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'englishtitle' => 2, 'filename' => 3, 'description' => 4, 'order_priority' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TagPeer::ENGLISHTITLE);

		$criteria->addSelectColumn(TagPeer::FILENAME);

		$criteria->addSelectColumn(TagPeer::DESCRIPTION);

		$criteria->addSelectColumn(TagPeer::ORDER_PRIORITY);
	...
	const COUNT = 'COUNT(tag_mst.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tag_mst.ID)';
