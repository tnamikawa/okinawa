...
/**
 * Base class that represents a row from the 'carte_and_tag_rel' table.
 *
 * 
 *
...
abstract class BaseCarteAndTag extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the carte_id field.
	 * @var        int
	 */
	protected $carte_id;
	...
	const PEER = 'CarteAndTagPeer';

	/**
	 * Get the [carte_id] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [carte_id] column.
	 * 
	 * @param      int $v new value
	 * @return     CarteAndTag The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->carte_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 3; // 3 = CarteAndTagPeer::NUM_COLUMNS - CarteAndTagPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CarteAndTagPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseCarteAndTag:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseCarteAndTag:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseCarteAndTag:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseCarteAndTag:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				CarteAndTagPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CarteAndTag (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CarteAndTag Clone of current object.
	 * @throws     PropelException
	 */
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseCarteAndTag:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseCarteAndTag::%s', $method));
	  }
