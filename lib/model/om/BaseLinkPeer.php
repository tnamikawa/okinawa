...
abstract class BaseLinkPeer {
	...
	const ID = 'link_mst.ID';

	
	const URL = 'link_mst.URL';

	
	const TITLE = 'link_mst.TITLE';

	
	const DESCRIPTION = 'link_mst.DESCRIPTION';

	
	const CATEGORY_ID = 'link_mst.CATEGORY_ID';

	
	const INSERTED_AT = 'link_mst.INSERTED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Url', 'Title', 'Description', 'CategoryId', 'InsertedAt', ),
		BasePeer::TYPE_COLNAME => array (LinkPeer::ID, LinkPeer::URL, LinkPeer::TITLE, LinkPeer::DESCRIPTION, LinkPeer::CATEGORY_ID, LinkPeer::INSERTED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'url', 'title', 'description', 'category_id', 'inserted_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Url' => 1, 'Title' => 2, 'Description' => 3, 'CategoryId' => 4, 'InsertedAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (LinkPeer::ID => 0, LinkPeer::URL => 1, LinkPeer::TITLE => 2, LinkPeer::DESCRIPTION => 3, LinkPeer::CATEGORY_ID => 4, LinkPeer::INSERTED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'url' => 1, 'title' => 2, 'description' => 3, 'category_id' => 4, 'inserted_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LinkPeer::TITLE);

		$criteria->addSelectColumn(LinkPeer::DESCRIPTION);

		$criteria->addSelectColumn(LinkPeer::CATEGORY_ID);

		$criteria->addSelectColumn(LinkPeer::INSERTED_AT);

	}

	const COUNT = 'COUNT(link_mst.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT link_mst.ID)';
