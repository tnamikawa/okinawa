...
abstract class BaseLinkCategory extends BaseObject  implements Persistent {
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = LinkCategoryPeer::TITLE;
		}
	...
	public function setOrderPriority($v)
	{
		...
		if ($this->order_priority !== $v) {
			...
			$this->modifiedColumns[] = LinkCategoryPeer::ORDER_PRIORITY;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->order_priority = $rs->getInt($startcol + 2);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setOrderPriority($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LinkCategoryPeer::TITLE)) $criteria->add(LinkCategoryPeer::TITLE, $this->title);
		if ($this->isColumnModified(LinkCategoryPeer::ORDER_PRIORITY)) $criteria->add(LinkCategoryPeer::ORDER_PRIORITY, $this->order_priority);
