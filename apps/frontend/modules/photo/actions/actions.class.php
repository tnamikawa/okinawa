...
{
  public function executeAjaxgetphoto()
  {
    $photoid = $this->getRequestParameter('photoid');
    $prev = $this->getRequestParameter('prevcnt');
    $next = $this->getRequestParameter('nextcnt');
    $vtagid = $this->getRequestParameter('vtagid');
    $htagid = $this->getRequestParameter('htagid');
...
/*
  public function executeAjaxthumblist()
  {
    $photoid = $this->getRequestParameter('photoid');
    $tagid = $this->getRequestParameter('tagid');
    $prev = $this->getRequestParameter('prevcnt');
    $next = $this->getRequestParameter('nextcnt');
    $vorh = $this->getRequestParameter('vorh');
...
*/
  ...
  public function executeBlogparts()
  {
    $c = new Criteria();
    $c->add(PhotoPeer::OPEN_DATE, null, Criteria::ISNOTNULL);
  ...
  public function executeBlogphotolink()
  {
    if (strlen($this->getRequestParameter('date'))) {
      $datestr = substr($this->getRequestParameter('date'), 0, 4) . '-' . substr($this->getRequestParameter('date'), 4, 2) . '-' . substr($this->getRequestParameter('date'), 6, 2);
    }
    else {
  ...
  public function executeEnglishtop()
  {
    $c = new Criteria();
    $c->add(PhotoPeer::OPEN_DATE, null, Criteria::ISNOTNULL);
    $this->count = PhotoPeer::doCount($c);
    ...
    $this->hour = $this->getRequestParameter('hour', ((int)strftime('%H')));
  ...
  public function executeIntroduction()
  {
  ...
  public function executeKeyword()
  {
    // タイトル文字列からタグIDを取得
    $c = new Criteria();
    $c->add(TagPeer::TITLE, $this->getRequestParameter('title'));
    $tag = TagPeer::doSelectOne($c);
    $this->tag = $tag;
    
    if (is_object($tag) && $tag instanceof Tag) {
      ...
      // index
      $this->index = (int)($this->getRequestParameter('index'));
    }
    else {
  ...
  public function executeKeywordindex()
  {
    $c = new Criteria();
  ...
  public function executeKeywordpage()
  {
  ...
  public function executeKeywordphotos()
  {
    
    $c = new Criteria();
    $c->add(TagPeer::ID, $this->getRequestParameter('id'));
    $tag = TagPeer::doSelectOne($c);
    $this->tag = $tag;
  ...
  public function executeMap()
  {
    ...
    $lng = str_replace('_', '.', $this->getRequestParameter('longitude'));
    $lat = str_replace('_', '.', $this->getRequestParameter('latitude'));
    $zoom = $this->getRequestParameter('zoom');
  ...
  public function executeNotewrite()
  {
    $FONT_FAMILY = array(
  ...
  public function executePhotoinmap() {
  ...
  public function executeSeolink()
  {
  ...
  {
    $c = new Criteria();
    $c->add(PhotoPeer::ID, $this->getRequestParameter('id'));
    $c->add(PhotoPeer::OPEN_DATE, null, Criteria::ISNOTNULL);
  ...
  */
  ...
  public function executeWallpapersample() {
    $id = $this->getRequestParameter('id');
    $wh = $this->getRequestParameter('size');
  ...
  public function executeWallpaper() {
    $id = $this->getRequestParameter('id');
    $wh = $this->getRequestParameter('size');
  ...
  public function executeWallpaperlist()
  {
    $c = new Criteria();
    $c->add(PhotoPeer::OPEN_DATE, null, Criteria::ISNOTNULL);
    $this->count = PhotoPeer::doCount($c);
  ...
  public function executeWanderupdate()
  {
    $photo = PhotoPeer::retrieveByPk($this->getRequestParameter('photoid'));
